...
public class LeerNumerosIdentificarPositivoV2
{
  public static void main(String[] args)
  {
    ...
    for (int i = 0; i<contadorPositivos; i++)
      {
        /*
      Cambio en V2 porque, aunque funciona igual, GMN me dice: "La corrección i < contadorPositivos es necesaria por si alguna vez cambias la lógica y decides incluir el cero como "no-negativo" (es decir, usas if (numeros[i] >= 0)), el código V1 solo imprimiría el 10, perdiendo el 0 y el 20.
      */
